(function() {
  ...
  // Rather than just binding keys, we keep track of which keys are down
  // and which are up. This technique allows for smoother keystroke
  // interaction when maneuvering the ship.
  ...
  // to user actions. This way, the stream of bullets is more manageable
  // and the ship's tail is only drawn when the user pushes up.
